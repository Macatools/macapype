...
The same Kepkee's :class:`full pipeline <macapype.pipelines.full_segment.create_full_segment_pnh_subpipes>`, used on marmouset data (:ref:`link to example <plot_segment_marmo_test>`). The automated cropping did not work, hence manual cropping was used. AtlasBREX parameters were modified accordingly.
