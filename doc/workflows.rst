...
.. code:: bash
    ...
    $ python workflows/segment_pnh_spm_based.py -data ~/Data_maca -out ./local_test -subjects Elouk -sess 01
    $ python workflows/segment_pnh_spm_based.py -data ~/Data_maca -out ./local_test -subjects Elouk

You can also specify a json file containing the parameters of your analysis

.. code:: bash

    $ python workflows/segment_pnh_spm_based.py -data ~/Data_maca -out ./local_test -params params.json
