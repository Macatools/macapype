...
def create_masked_correct_bias_pipe(sigma, name= "masked_correct_bias_pipe"):
    ...
    masked_correct_bias_pipe.connect(inputnode,'preproc_T1',mult_T1_T2,'in_file')
    masked_correct_bias_pipe.connect(inputnode,'preproc_T2',mult_T1_T2,'operand_file')

    ### mask mult
    mask_mult = pe.Node(fsl.ApplyMask(),name = 'mask_mult')

    masked_correct_bias_pipe.connect(mult_T1_T2,'out_file',mask_mult,'in_file')
    masked_correct_bias_pipe.connect(inputnode,'brain_mask',mask_mult,'mask_file')

    ## Mean Brain Val
    meanbrainval = pe.Node(fsl.ImageStats(),name ='meanbrainval')
    meanbrainval.inputs.op_string = "-M"

    masked_correct_bias_pipe.connect(mult_T1_T2,'out_file',meanbrainval,'in_file')

    ### norm_mult
    norm_mult= pe.Node(fsl.BinaryMaths(),name = 'norm_mult')
    norm_mult.inputs.operation = "div"

    masked_correct_bias_pipe.connect(mask_mult,'out_file',norm_mult,'in_file')
    masked_correct_bias_pipe.connect(meanbrainval,('out_stat',print_val),norm_mult,'operand_value')
    ...
    masked_correct_bias_pipe.connect(norm_mult,'out_file',norm_smooth,'in_file')
    masked_correct_bias_pipe.connect(smooth,'out_file',norm_smooth,'operand_files')
    #masked_correct_bias_pipe.connect(smooth,('out_file',print_nii_data),norm_smooth,'operand_files')
    ...
    masked_correct_bias_pipe.connect(norm_mult,'out_file',modulate,'in_file')
    masked_correct_bias_pipe.connect(norm_smooth,'out_file',modulate,'operand_file')
    #masked_correct_bias_pipe.connect(norm_smooth,('out_file',print_nii_data),modulate,'operand_file')

    ### std_modulate
    std_modulate = pe.Node(fsl.ImageStats(),name ='std_modulate')
    std_modulate.inputs.op_string = "-S"

    masked_correct_bias_pipe.connect(modulate,'out_file',std_modulate,'in_file')
    #masked_correct_bias_pipe.connect(modulate,('out_file',print_nii_data),std_modulate,'in_file')

    ### mean_modulate
    mean_modulate = pe.Node(fsl.ImageStats(),name ='mean_modulate')
    mean_modulate.inputs.op_string = "-M"

    masked_correct_bias_pipe.connect(modulate,'out_file',mean_modulate,'in_file')
    ...
    masked_correct_bias_pipe.connect(mean_modulate,'out_stat',lower,'mean_val')
    masked_correct_bias_pipe.connect(std_modulate,'out_stat',lower,'std_val')

    ### thresh_lower
    thresh_lower = pe.Node(fsl.Threshold(),name ='thresh_lower')


    masked_correct_bias_pipe.connect(lower,'lower_val',thresh_lower,'thresh')
    masked_correct_bias_pipe.connect(modulate,'out_file',thresh_lower,'in_file')
    ...
    #masked_correct_bias_pipe.connect(correct_bias,'thresh_lower_file',mod_mask,'in_file') #OR
    masked_correct_bias_pipe.connect(thresh_lower,'out_file',mod_mask,'in_file')
    ...
    #masked_correct_bias_pipe.connect(correct_bias,'norm_mult_file',bias,'in_file') #OR
    masked_correct_bias_pipe.connect(norm_mult,'out_file',tmp_bias,'in_file')

    masked_correct_bias_pipe.connect(mod_mask,'out_file',tmp_bias,'operand_files')
    ...
    masked_correct_bias_pipe.connect(mod_mask,'out_file',bias,'operand_files')
    ...
    masked_correct_bias_pipe.connect(inputnode,'preproc_T1', restore_T1,'in_file')
    masked_correct_bias_pipe.connect(smooth_bias,'out_file',restore_T1,'operand_file')
    ...
    masked_correct_bias_pipe.connect(inputnode,'preproc_T2', restore_T2,'in_file')
    masked_correct_bias_pipe.connect(smooth_bias,'out_file',restore_T2,'operand_file')
    ...
    masked_correct_bias_pipe.connect(restore_T1,'out_file', restore_mask_T1,'in_file')
    masked_correct_bias_pipe.connect(inputnode,'brain_mask',restore_mask_T1,'mask_file')

    ### restore_mask_T2
    restore_mask_T2 = pe.Node(fsl.ApplyMask(),name = 'restore_mask_T2')

    masked_correct_bias_pipe.connect(restore_T2,'out_file', restore_mask_T2,'in_file')
    masked_correct_bias_pipe.connect(inputnode,'brain_mask',restore_mask_T2,'mask_file')
