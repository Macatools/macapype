...
from macapype.pipelines.full_pipelines import \
    (create_full_T1T2_subpipes, create_full_T1_subpipes)

cwd = Path.cwd()
data_path = make_tmp_dir()


def test_create_full_T1T2_subpipes_no_args():
    ...
    # running workflow
    segment_pnh = create_full_T1T2_subpipes(
        params=params,
...
def test_create_full_T1T2_subpipes_all_default_params():
...
def test_create_full_T1_subpipes_all_default_params():
    ...
    for soft, species, space, pad in product(softs, all_species, spaces, pads):
        ...
        # running workflow
        segment_pnh = create_full_T1_subpipes(
            params=params,
            params_template_stereo=params_template,
            params_template_brainmask=params_template,
            params_template_seg=params_template,
