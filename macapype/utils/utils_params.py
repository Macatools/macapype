...
def update_params(ssoft=[], subjects=None, sessions=None, params_file=None, indiv_params_file=None):
    ...
    if indiv_params_file is None:
        ...
        if "short_preparation_pipe" in params.keys():
            ...
            if "crop_T1" in params["short_preparation_pipe"].keys():
                ...
                #params["short_preparation_pipe"]["bet_crop"] = {"args": "-rigOnly -smooR 1 -noSym -ln 12 -lp 10"}
            ...
            print('**** params modification if no indiv_params not implemented ****')
        ...
        if "short_preparation_pipe" not in params.keys():
            ...
            if subjects is None or sessions is None:
                ...
                if prep_pipe == "short_preparation_pipe":
                    ...
                    if "crop_aladin_T1" in params["short_preparation_pipe"].keys():
                        print("Deleting crop_aladin_T1")
                        del params["short_preparation_pipe"]["crop_aladin_T1"]


                    print("Adding crop_T1")
                    params["short_preparation_pipe"]["crop_T1"] = {"args": "should be defined in indiv"}
                else:
