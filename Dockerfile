...
RUN  pip install --index-url https://test.pypi.org/simple/ --pre --extra-index-url https://pypi.org/simple/ macapype && python -c "import macapype; print(macapype.__version__)"
