...
project = 'SkullTo3d'
td = date.today()
copyright = u'%s, SkullTo3d Developers (macatools). Last updated on %s' % (td.year,
                                                                td.isoformat())

author = 'SkullTo3d Developers (macatools)'
...
version = skullTo3d.__version__

# The full version, including alpha/beta/rc tags.
release = skullTo3d.__version__
...
# documentation.
#
html_logo = "img/logo/logo_skullTo3d_alpha.jpg"
